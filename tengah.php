...
echo'<div class="banner">
  ...
  while ($r=mysql_fetch_array($sql)){
	...
	echo " <div class='product-info'>
		<img height ='100px' src='foto_produk/small_$r[gambar]' border='0' />
...
elseif ($_GET[module]=='about'){
	echo "<div class='content' id='body' class='tengah'>
			<hr>
			<h3>Anggota Kelompok XX</h3><br><br>
			<div class='tengah'></div>
			<id='sintong'><strong>Sintong Kristiansen PH Marbun</strong>
			<p>Hallo, Nama saya Sintong Kristiansen PH Marbun , Biasa di panggil Sintong saya dari kota pacitan provinsi jawa timur, 
                hoby traveling cita cita ingin menjadi pengajar (lecturer),membangun usaha starup, dan membahagiakan orang tua  </p>
			<div>
			<img src='foto_banner/sintong.jpg' width='30%' height='250'/></div><br/>
			<p>saat ini saya sedang menempuh pendidikan strata satu di fasilkom universitas esa unggul jakarta 
                dengan program study teknik informatika</p>
			<p>--------------------------------------------------------------</p><br/>
			</div>
			
			<div class='content' id='body' class='tengah'>
			<div class='tengah'></div>
			<id='windo'><strong>Windo Yofena</strong>
			<p>Hallo, Nama saya  Windo Yofena, Biasa di panggil Windo saya Lahir di Rembang hoby traveling cita cita ingin menjadi pengusaha dan membahagiakan orang tua </p>
			<div>
			<img src='foto_banner/windo.jpg' width='30%' height='250'/></div><br/>
			<p>saat ini saya sedang menempuh pendidikan strata satu di fasilkom universitas esa unggul jakarta dengan program study teknik informatika</p><br/>
			<p>--------------------------------------------------------------</p>
      </div>
      
      <div class='content' id='body' class='tengah'>
			<div class='tengah'></div>
      <strong>Imam Mujahid As Salafy</strong>
      <p>Hallo, Nama saya  Imam Mujahid As-Salafy , Biasa di panggil Imam saya Lahir di jakarta hoby traveling cita cita ingin menjadi pengusaha dan membahagiakan orang tua  </p>
      <div>
      <img src='foto_banner/imam.jpg' width='30%' height='250' /></div>
      <br/>
      <br/>
      <p>saat ini saya sedang menempuh pendidikan strata satu di fasilkom universitas esa unggul jakarta dengan program study teknik informatika</p>
      <p>--------------------------------------------------------------</p>
      </div>";
}
